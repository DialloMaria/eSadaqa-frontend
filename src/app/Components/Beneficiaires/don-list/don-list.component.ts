...
export class DonsListComponent implements OnInit {
  dons: DonModel[] = [];
...
@Output() reserveDon = new EventEmitter<number>();
  ...
  constructor(private beneficiaireService: BeneficiaireService, private router: Router,private dialog: MatDialog, authsercie: AuthService) {
